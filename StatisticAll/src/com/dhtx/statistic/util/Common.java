...
public class Common {
	...
	static DataConnect dc = null;  //if (dc != null) new DataConnect("CardServer", false)

	public boolean isUpdate = false;	//是否有更新操�?会影响页面的刷新方式
	...
	public String getStat(String sData, String sName){
		return getStat(sData, sName, "");
	}

	public String getStat(String sData, String sName, String sDefValue){
		String sRow = fc.getString(sData, "<stat>", "</stat>");
		String s = fc.getString(sRow, "<" + sName + ">", "</" + sName + ">");
		if (s.equals("")) s = sDefValue;
		return s;
	}
	...
	/*
	 * 返回按钮名称及可用属�?first,prev,next,last,goto,inpage
	 */
