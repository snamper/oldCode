...
strFrame='<style>';
strFrame+='INPUT.button{BORDER-RIGHT: #9CB5BE 1px solid;BORDER-TOP: #9CB5BE 1px solid;BORDER-LEFT: #9CB5BE 1px solid;';
strFrame+='BORDER-BOTTOM: #9CB5BE 1px solid;BACKGROUND-COLOR: #9CB5BE;font-family:宋体;}';
...
strFrame+='<table border=1 cellspacing=0 cellpadding=0 width=142 height=160 bordercolor=#9CB5BE bgcolor=#9CB5BE >';
...
strFrame+='                <td width=16 align=center bgcolor=#9CB5BE style="font-size:12px;cursor: hand;color: #ffffff" ';
strFrame+='        onclick="parent.meizzPrevM()" title="向前翻 1 月" ><b >&lt;</b></td>';
strFrame+='       <td width=60 align="center" bgcolor="#9CB5BE" style="font-size:12px;cursor:hand" ';
strFrame+='           onmouseover="style.backgroundColor=\'#aaccf3\'"';
strFrame+='        onmouseout="style.backgroundColor=\'#9CB5BE\'" ';
...
strFrame+='        bgcolor="#9CB5BE" onmouseover="style.backgroundColor=\'#aaccf3\'" ';
strFrame+='        onmouseout="style.backgroundColor=\'#9CB5BE\'" ';
...
strFrame+='       <td width=16 bgcolor=#9CB5BE align=center style="font-size:12px;cursor: hand;color: #ffffff" ';
strFrame+='        onclick="parent.meizzNextM()" title="向后翻 1 月" ><b >&gt;</b></td>';
strFrame+='      </tr>';
strFrame+='     </table></td></tr>';
strFrame+='    <tr><td width=142 height=18 >';
strFrame+='     <table border=0 cellspacing=0 cellpadding=2 bgcolor=#9CB5BE ' + (bMoveable? 'onmousedown="DragStart()" onmouseup="DragEnd()"':'');
strFrame+='    BORDERCOLORLIGHT=#9CB5BE BORDERCOLORDARK=#FFFFFF width=140 height=20 style="cursor:' + (bMoveable ? 'move':'default') + '">';
...
strFrame+='    <table border=1 cellspacing=2 cellpadding=2 BORDERCOLORLIGHT=#9CB5BE BORDERCOLORDARK=#FFFFFF bgcolor=#fff8ec width=140 height=120 >';
...
strFrame+='          <tr bgcolor="#9CB5BE"><td id=bUseTimeLayer width=30 style="cursor:hand" title="点击这里启用/禁用时间"';
strFrame+='    onmouseover="style.backgroundColor=\'#aaccf3\'" align=center onmouseout="style.backgroundColor=\'#9CB5BE\'"';
...
strFrame+=' onmouseover="style.backgroundColor=\'#aaccf3\'" onmouseout="style.backgroundColor=\'#9CB5BE\'"';
...
//根据当前输入框的日期显示日历的年月
var reg = /^(\d+)-(\d{1,2})-(\d{1,2}) (\d{1,2}):(\d{1,2}):(\d{1,2})/; //不含时间
...
{
	//alert("meizzWriteHead:" + meizzTheSecond);
odatelayer.meizzYearHead.innerText = yy + " 年";
odatelayer.meizzMonthHead.innerText = format(mm) + " 月";
//插入当前小时、分
odatelayer.meizzHourHead.innerText=bUseTime?(parent.meizzTheHour+" 时"):""; 
odatelayer.meizzMinuteHead.innerText=bUseTime?(parent.meizzTheMinute+" 分"):"";
odatelayer.meizzSecondHead.innerText=bUseTime?(parent.meizzTheSecond+" 秒"):"";
}
...
{
//初始化边框
da.borderColorLight="#9CB5BE";
da.borderColorDark="#9CB5BE";
...
var hh=parent.meizzTheHour;
var mi=parent.meizzTheMinute;
var se=parent.meizzTheSecond;
//判断月份，并进行对应的处理
...
if (mi<10 && hh.length > 2) {mi="0" + mi;} //分
if (se<10 && hh.length > 2) {se="0" + se;} //秒
