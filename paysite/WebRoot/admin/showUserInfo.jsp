...
<div id="title">
  ...
  <div id="title_left">位置：查看基本信息</div>
</div>
<!--表单开始-->
<div id="search_list_content">
<form action="<%=basePath %>client.do?method=updateClientPage" method="post">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td width="100" height="30" align="left" class="bk02" >用户名: </td>
      <td align="center" class="bk02" ><input name="username" type="text" class="txt_05" value="<%=currentClient[3] %>" size="25" />
      </td>
      <td class="bk02">&nbsp;</td>  
    </tr>  
    <tr >
      <td height="30" align="left" class="bk02" >登录密码: </td>
      <td align="center" class="bk02"><input name="textfield232626" type="text" class="txt_05" size="25" value="<%=currentClient[2] %>"/></td>
    ...
    <tr >
      ...
      <td align="center" class="bk02"><input name="textfield2326212" type="text" class="txt_05" size="25" value="<%=currentClient[12] %>"/></td>
      <td class="bk02">&nbsp;</td>
    </tr>
   
    <tr >
      <td height="30" align="left" class="bk02" >Email: </td>
      <td align="center" class="bk02"><input name="textfield2326214" type="text" class="txt_05" size="25" value="<%=currentClient[10] %>"/></td>
      <td class="bk02">&nbsp;</td>
    </tr>
    <tr >
      <td height="30" align="left" class="bk02" >QQ或MSN: </td>
      <td align="center" class="bk02"><input name="textfield2326215" type="text" class="txt_05" size="25" value="<%=currentClient[11] %>"/></td>
      <td class="bk02">&nbsp;</td>
    </tr>
     <tr >
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      <td height="22" align="left" class="font8"><input name="Submit2422" type="submit" class="button_09" value="修改" />
      </td>
      <td align="right">&nbsp;</td>
    </tr>
    <tr>
