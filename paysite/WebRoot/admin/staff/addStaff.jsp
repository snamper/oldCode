...
<input type="hidden" name="fstate" id="fstate" value=""/>
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
   <tr >  
      ...
      <input  name="fid" id="fid" type="text" class="txt_05" size="25" value=""/></td>
      <td class="bk02">&nbsp;&nbsp;<span class="font7"></span></td>
    </tr>
     <tr >  
      <td height="30" width="150" align="left"  class="bk02" >&nbsp;&nbsp;&nbsp;&nbsp; 登录密码: </td>
      <td align="left" class="bk02" width="200">
      <input  name="fpassword" id="fpassword" type="text" class="txt_05" size="25" value=""/></td>
      <td class="bk02">&nbsp;&nbsp;<span class="font7"></span></td>
    </tr>
     <tr >  
      <td height="30" width="150" align="left"  class="bk02" >&nbsp;&nbsp;&nbsp;&nbsp; 再次输入密码: </td>
      <td align="left" class="bk02" width="200">
      <input  name="fpassword2" id="fpassword2" type="text" class="txt_05" size="25" value=""/></td>
      <td class="bk02">&nbsp;&nbsp;<span class="font7"></span></td>
    </tr>
     <tr >  
      <td height="30" width="150" align="left"  class="bk02" >&nbsp;&nbsp;&nbsp;&nbsp;员工姓名: </td>
      <td align="left" class="bk02" width="200">
      <input  name="fname" id="fname" type="text" class="txt_05" size="25" value=""/></td>
      <td class="bk02">&nbsp;&nbsp;<span class="font7"></span></td>
    </tr> 
    <tr >  
...
function checksub(){
	...
	new Ajax.Request('staff.do?method=addStaff', {    
		asynchronous: true,
		method:'post',   
