...
function checksubmit(){  
	  if(window.confirm("确定要提交吗？"))
	  {
		...
		new Ajax.Request('general.do?method=addCardOrderUrlAjax', {  
				asynchronous: true,
				method:'post',   
				parameters: "xmlFile="+xmlFile+"&clientId="+clientId+"&productId="+productId+"&money="+money+"&cradno="+cardno+"&cardpassword="+cardpassword,
				onComplete: function(request) {
				 var id=request.responseText;
				     alert(id);
					     history.back(-1);      
