...
import com.jinrl.powermodule.pojo.Tdepartment;

/**
 * A data access object (DAO) providing persistence and search support for
 * Tdepartment entities. Transaction control of the save(), update() and
 * delete() operations can directly support Spring container-managed
 * transactions or they can be augmented to handle user-managed Spring
 * transactions. Each of these methods provides additional information for how
 * to configure it for the desired type of transaction control.
 * 
 * @see com.jinrl.powermodule.pojo.Tdepartment
 * @author MyEclipse Persistence Tools
 */

public class TdepartmentDAO extends BaseHibernateDAO {
	private static final Logger log = LoggerFactory
			.getLogger(TdepartmentDAO.class);
	// property constants
	public static final String FDENAME = "fdename";
	...
	public Tdepartment findById(java.lang.String id) {
		log.debug("getting Tdepartment instance with id: " + id);
		try {
			Tdepartment instance = (Tdepartment) getSession().get(
					"com.jinrl.powermodule.pojo.Tdepartment", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Tdepartment instance) {
		...
		try {
			List results = getSession().createCriteria(
					"com.jinrl.powermodule.pojo.Tdepartment").add(
	...
	public List findByFdename(Object fdename) {
		return findByProperty(FDENAME, fdename);
	}
	...
	public List findAll() {
		log.debug("finding all Tdepartment instances");
		try {
			String queryString = "from Tdepartment";
			Query queryObject = getSession().createQuery(queryString);
			return queryObject.list();
		} catch (RuntimeException re) {
	...
	public Tdepartment merge(Tdepartment detachedInstance) {
		...
		try {
			Tdepartment result = (Tdepartment) getSession().merge(
					detachedInstance);
